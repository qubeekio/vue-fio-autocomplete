...
axios_1.default = _default;var axios = axios_1;var script = {
  ...
  watch: {
    inputValue: function inputValue(newVal, oldVal) {
      ...
      if (!this.originalValue) {
        ...
        var diff = Math.abs(oldVal.length - (newVal ? newVal.length : 0));
  ...
  methods: {
    ...
    setInputValue: function setInputValue(_ref2) {
      ...
      this.inputValue = this.inputValue.toLowerCase().replace(/[А-Яа-яЁёA-Za-z]\S*/g, function (w) {
